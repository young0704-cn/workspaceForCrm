		...
		$("#create-save").click(function(){
			$.ajax({
				...
				success:function (result_data) {
                    ...
                    pageList(1,$("#clubPage").bs_pagination('getOption', 'rowsPerPage'));
				}
			})
		})
				...
				<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input class="form-control" type="text" id="mphon">
				    </div>
				  </div>
				  ...
				  <button type="submit" class="btn btn-default" id="getbtn">查询</button>
